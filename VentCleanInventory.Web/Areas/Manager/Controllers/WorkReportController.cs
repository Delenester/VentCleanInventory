...
public class WorkReportController(ApplicationDbContext db, UserManager<ApplicationUser> userManager) : Controller
{
    [HttpGet]
    public async Task<IActionResult> Index(DateTime? from = null, DateTime? to = null)
    {
        ...
        var rows = logs.Select(l => new WorkReportViewModel.Row
        {
            Id = l.Id,
